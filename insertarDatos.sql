...
INSERT INTO `anuncio` (`id`, `usuario_id`, `titulo`, `descripcion`, `precio`, `fecha_crea`, `fecha_mod`) VALUES
	(1, 1, 'sdfas', 'asdfdasf', 23423422.00, '2020-01-27 22:25:56', '2020-01-27 22:25:57');
/*!40000 ALTER TABLE `anuncio` ENABLE KEYS */;

-- Volcando datos para la tabla segundamano_rol.foto: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `foto` DISABLE KEYS */;
INSERT INTO `foto` (`id`, `anuncio_id`, `nombre`, `principal`) VALUES
	(1, 1, 'sdfads', 1);
...
INSERT INTO `usuario` (`id`, `provincia_id`, `email`, `password`, `nombre`, `apellidos`, `telefono`, `foto`) VALUES
	(1, 15, '1', 'dsafasdfasd', 'afsdfds', 'sadefasdfas', 'sadfasdf', 'asfdas');
